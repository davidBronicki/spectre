...
#include "Evolution/Systems/EM/Constraints.hpp"
...
struct InitializeConstraints {
  using simple_tags = tmpl::list<EM::Tags::ConstraintDampening>;
  ...
  static Parallel::iterable_action_return_t apply(
    ...
    Scalar<DataVector> constraint{mesh.number_of_grid_points(), 0.};
